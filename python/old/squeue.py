...
def get_squeue(job_dict,key=None):
...
if __name__ == "__main__":
    ...
    try:
        ...
        if len(jobs) > 0:
            ...
            print("SQueue,metric=num_jobs,hostname={0} {1}".format(socket.gethostname(),num_jobs))
            print("SQueue,metric=num_cpus,hostname={0} {1}".format(socket.gethostname(),num_cpus))
        else:
            print("No jobs found !")
